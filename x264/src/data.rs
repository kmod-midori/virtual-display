...
pub enum Priority {
    ...
    Disposable = nal_priority_e_NAL_PRIORITY_DISPOSABLE,
    /// Not very important.
    Low = nal_priority_e_NAL_PRIORITY_LOW,
    /// Pretty important.
    High = nal_priority_e_NAL_PRIORITY_HIGH,
    /// Extremely important.
    Highest = nal_priority_e_NAL_PRIORITY_HIGHEST,
}
