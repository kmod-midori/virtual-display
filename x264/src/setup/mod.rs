...
impl Setup {
        ...
        C: Into<Encoding>,
    {
        ...
        self.raw.i_keyint_max = 30;
        self.raw.b_intra_refresh = 1;

        self.raw.rc.i_rc_method = X264_RC_CRF as i32;
        self.raw.rc.f_rf_constant = 25.0;
        self.raw.rc.f_rf_constant_max = 35.0;

        let raw = unsafe { x264_encoder_open_any(&mut self.raw) };
